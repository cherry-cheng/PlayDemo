...
public class VarietySPresenter extends AbsBasePresenter<VarietySContract.View> {

    private static final String TAG = VarietySPresenter.class.getSimpleName();

    private Recommend1Apis mRecommend1Apis;

    @Inject
    public VarietySPresenter(Recommend1Apis regionApis) {
