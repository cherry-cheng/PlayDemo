...
public class SeriesSFragment extends BaseMvpFragment<SeriesSPresenter> implements SeriesSContract.View {
    ...
    protected void initViewAndEvent() {
        ...
        Log.i("cyh555", "bundle SeriesSFragment = " + searchword);
        mPresenter.onDataSearch("tvshowinfo", searchword);
    }
    ...
    public void onEvent(VisibleClickSearch visibleClickSearch) {
        ...
        mPresenter.onDataSearch("tvshowinfo", visibleClickSearch.getSearchword());
    }
}
