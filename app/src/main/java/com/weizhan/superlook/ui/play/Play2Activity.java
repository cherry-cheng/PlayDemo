...
public class Play2Activity extends BaseActivity implements IBaseMvpActivity<Play2Presenter>, Play2Contract.View {

    private IjkVideoView ijkVideoView;
    private SharePopWindow sharePopWindow;
    @Inject
    Play2Presenter mPresenter;
    ...
    public void initViewAndEvent() {
        ...
        playTitleItemViewBinder.setClickListenr(new PlayTitleItemViewBinder.tvClick() {
            ...
            public void onUserLoveClick(ImageView imageView, int id, int type, int isLove) {
                if (SpUtils.getBoolean(Play2Activity.this, "isLogin", false)) {
            ...
            public void onUserShareClick(ImageView imageView) {
                //分享应用
                sharePopWindow = new SharePopWindow(Play2Activity.this, itemsOnClick);
    ...
    @Override
    public Play2Presenter getPresenter() {
        return mPresenter;
    }
...
//            ijkVideoView.setScreenScale(IjkVideoView.SCREEN_SCALE_CENTER_CROP);
    ...
    private View.OnClickListener itemsOnClick = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            sharePopWindow.backgroundAlpha(Play2Activity.this, 1f);
            switch (view.getId()) {
                case R.id.weixinf:
                    ShareUtil.weiXin(view, Play2Activity.this);
                    break;
                case R.id.wechatc:
                    ShareUtil.weixinCircle(view, Play2Activity.this);
                    break;
                case R.id.sina:
                    ShareUtil.sina(view, Play2Activity.this);
                    break;
                default:
                    break;
            }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        UMShareAPI.get(Play2Activity.this).onActivityResult(requestCode, resultCode, data);
        Log.i("cyh333", "有回调妈？？？？？？？？");
    }
}
