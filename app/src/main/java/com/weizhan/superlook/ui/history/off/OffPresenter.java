...
public class OffPresenter extends AbsBasePresenter<OffContract.View> {

    private static final String TAG = OffPresenter.class.getSimpleName();

    private Recommend1Apis mRecommend1Apis;

    @Inject
    public OffPresenter(Recommend1Apis regionApis) {
